...
namespace PatternGeneration
{
    public partial class Form1 : Form
    {
        ...
        private void Generate()
        {
            ...
            {
                dataGridView1.Rows.Add(randomNumbers.Next(colors), randomNumbers.Next(colors), randomNumbers.Next(colors), randomNumbers.Next(colors), randomNumbers.Next(colors));
            }
